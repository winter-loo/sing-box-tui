...
pub(super) fn test_app() -> App {
    ...
    App {
        ...
        sustained_runtime_environment: None,
        ...
        background_probe_selectors: std::collections::BTreeMap::new(),
        last_background_probe_started: std::collections::BTreeMap::new(),
        filter_input: None,
        bypass_input: None,
        ...
        active_node_traffic: Default::default(),
